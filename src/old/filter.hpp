...
namespace Filter {
	...
	public:
		...
		inline float process(float b0) {
			...
			feedback = noi::Outils::clip(feedback, -5.f, 5.f);
			b0 += feedback;
			//shift new value in
			m_b[2] = noi::Outils::clip(m_b[1], -100.f, 100.f);
			m_b[1] = noi::Outils::clip(m_b[0], -100.f, 100.f);
			m_b[0] = b0;
			m_a[2] = noi::Outils::clip(m_a[1], -100.f, 100.f);
			m_a[1] = noi::Outils::clip(m_a[0], -100.f, 100.f);
